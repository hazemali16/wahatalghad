...
const Gallery = () => {
  return (<div className="px-5 py-20 gallery opacity-0 duration-500 translate-y-10" id="gallery">
    ...
    <div className="w-10/12 mx-auto max-md:w-full grid grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-5 mt-20">
        <div className="relative duration-500 opacity-0 translate-y-10">
            <Image src={gallery1} alt="gallery1" />
            <div className="absolute top-0 left-0 w-full h-full bg-[#00000090]"></div>
        </div>
        <div className="relative duration-500 delay-300 opacity-0 translate-y-10">
            <Image src={gallery2} alt="gallery2" />
            <div className="absolute top-0 left-0 w-full h-full bg-[#00000090]"></div>
        </div>
        <div className="relative duration-500 delay-700 opacity-0 translate-y-10">
            <Image src={gallery3} alt="gallery3" />
            <div className="absolute top-0 left-0 w-full h-full bg-[#00000090]"></div>
        </div>
        <div className="relative duration-500 delay-[1.3s] opacity-0 translate-y-10">
            <Image src={gallery4} alt="gallery4" />
            <div className="absolute top-0 left-0 w-full h-full bg-[#00000090]"></div>
        </div>
        <div className="relative duration-500 delay-[1.8s] opacity-0 translate-y-10">
            <Image src={gallery5} alt="gallery5" />
            <div className="absolute top-0 left-0 w-full h-full bg-[#00000090]"></div>
        </div>
        <div className="relative duration-500 delay-[2.3s] opacity-0 translate-y-10">
